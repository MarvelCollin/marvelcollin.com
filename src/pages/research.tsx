        ...
        <div className="mx-auto max-w-[900px] space-y-6">
          {PAPERS.map((p) => (
            <a
              ...
              className="group block rounded-xl border border-line p-8 transition-colors hover:border-muted hover:bg-bg-2 max-[560px]:p-5"
            >
              ...
              <div className="mt-4 flex flex-wrap items-center gap-2">
                ...
                <span className="ml-auto text-[13px] text-fg-dim transition-colors group-hover:text-fg max-[900px]:hidden">View repo →</span>
              </div>
            </a>
          ))}
        </div>
